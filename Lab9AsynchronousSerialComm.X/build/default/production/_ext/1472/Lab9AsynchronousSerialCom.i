...
# 27 "../Lab9AsynchronousSerialCom.asm" 2
; Include Statements
...
;Asynchronous Transmission
    ...
    BCF STATUS,6 ;BANK1
    ;MOVLW 0x1A
    ;MOVWF PIE1 ;0001|1010 ((PIE1) and 07Fh), 5 & ((PIE1) and 07Fh), 4 Int. Enable Bits & TIMRIF
...
RECEIVE:
    ...
    BTFSC STATUS,2 ;Check ((STATUS) and 07Fh), 2 flag, if set = $ from XOR
    GOTO SAW_DOLLAR
